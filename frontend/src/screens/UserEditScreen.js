...
function UserEditScreen({ match, history }) {
    ...
    const getuserR = useSelector(state => state.getuserR)
    const { error, loading, user } = getuserR
                    ...
                    : (
                        <Form onSubmit={submitHandler}>
                            ...
                            <Form.Group controlId='name'>
                                <Form.Label className="mt-2"><h4>Name : </h4></Form.Label>
                            ...
                            <Form.Group controlId='email'>
                                <Form.Label className="mt-3"><h4>Email Address : </h4> </Form.Label>
                                <Form.Control
                                    className="mb-2"
                                    required
                                    type='email'
