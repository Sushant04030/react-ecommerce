...
class Review(models.Model):
    ...
    createdAt       = models.DateTimeField(auto_now_add=True, editable=False)
    editedAt        = models.DateTimeField(auto_now=True, editable=False)
    _id             = models.AutoField(primary_key=True, editable=False)

    def __str__(self):
        return f"{self._id}. {self.product.name}, {self.user}, {self.rating}"
...
class Order(models.Model):
    ...
    paidAt          = models.DateTimeField(auto_now_add=False, editable=False, null=True)
    isDelivered     = models.BooleanField(default=False)
    deliveredAt     = models.DateTimeField(auto_now_add=True, editable=False, null=True)
